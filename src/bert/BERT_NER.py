...
import src.bert.metrics as metrics
...
class NerProcessor(DataProcessor):
    def get_train_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "pers_info_type_train.csv")), "train"
        )
    ...
    def get_test_examples(self, data_dir):
        return self._create_example(
            self._read_data(os.path.join(data_dir, "pers_info_type_test.csv")), "test"
        )
    ...
    def get_labels(self):
        ...
        :return:
        """
        return ["[PAD]", "O", "X", "B-COM", "I-COM", "B-CON", "I-CON", "B-COO", "I-COO", "B-DEM", "I-DEM", "B-FIN",
                "I-FIN", "B-GEN", "I-GEN", "B-HEA", "I-HEA", "B-IP", "I-IP", "B-LOC", "I-LOC", "B-PER", "I-PER",
                "B-SOC", "I-SOC", "B-SUR", "I-SUR", "B-ACT", "I-ACT", "B-PRO", "I-PRO", "B-OTH", "I-OTH", "B-UNS",
                "I-UNS", "[CLS]", "[SEP]"]
...
class BertNer:
    def __init__(self, do_train=False):
        ...
        if do_train:
            self.train_examples = self.data_processor.get_train_examples(FLAGS.data_dir)
            self.num_train_steps = int(len(self.train_examples) / FLAGS.train_batch_size * FLAGS.num_train_epochs)
